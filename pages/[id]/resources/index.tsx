...
export const ResourcePage = (): JSX.Element => {
  ...
  return (
    <RunnerLayout>
      ...
      <h2>Security</h2>
      <NextLink href={`${asPath}locks`} passHref>
        <Button variant="contained">Locks</Button>
      </NextLink>
      <NextLink href={`${asPath}restraints`} passHref>
        <Button variant="contained">Restraints</Button>
      </NextLink>
    </RunnerLayout>
  )
}
